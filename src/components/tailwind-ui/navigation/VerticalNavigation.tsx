  ...
  return (
    <div className="space-y-1">
      <button
        ...
        onClick={toggle}
        className={clsx(
          'flex items-center w-full pl-2 pr-1 py-2 rounded-md group hover:bg-gray-400 hover:bg-opacity-10 focus:outline-none focus:ring-2 focus:ring-primary-500',
          optionStyles[size],
        )}
      >
        {element.icon && (
