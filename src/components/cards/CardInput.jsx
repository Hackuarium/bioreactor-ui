...
const CardInput = ({
  ...
  return (
    <div className={clsx('flex ', className)}>
      <div
        className={clsx(
          'w-full m-2 p-2 flex flex-col justify-between items-center sm:items-start rounded-md bg-blue-gray-100 shadow',
      ...
      >
        ...
        <div className="w-full mt-2 flex flex-row justify-center sm:justify-end items-center">
          <input
            className="w-full p-1 bg-white border-neutral-200 text-right text-black text-sm font-bold placeholder-neutral-500 placeholder-opacity-30 rounded  focus:outline-none focus:ring-0 leading-none"
            id={title}
            name={title}
            type={type}
